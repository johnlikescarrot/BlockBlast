...
export class MenuScene extends Phaser.Scene
{
    ...
    create(){
        ...
        this.startButton.on('pointerover', function (event) {
            this.setTexture('menuUI', 'Play_Clicked.png'); this.scene.tweens.add({ targets: this, scale: 1.1, duration: 80 });
        });
        this.startButton.on('pointerout', function (event) {
            this.setTexture('menuUI', 'Play_NonClicked.png'); this.scene.tweens.add({ targets: this, scale: 1.0, duration: 80 });
        });
        ...
        this.helpButton.on('pointerover', function (event) {
            this.setTexture('menuUI', 'Info_Clicked.png'); this.scene.tweens.add({ targets: this, scale: 1.1, duration: 80 });
        });
        this.helpButton.on('pointerout', function (event) {
            this.setTexture('menuUI', 'Info_NonClicked.png'); this.scene.tweens.add({ targets: this, scale: 1.0, duration: 80 });
        });
        ...
        this.optionsButton.on('pointerover', function (event) {
            this.setTexture('menuUI', 'Settings_Clicked.png'); this.scene.tweens.add({ targets: this, scale: 1.1, duration: 80 });
            
        });
        this.optionsButton.on('pointerout', function (event) {
            this.setTexture('menuUI', 'Settings_NonClicked.png'); this.scene.tweens.add({ targets: this, scale: 1.0, duration: 80 });
        });
        ...
        this.creditsButton.on('pointerover', function (event) {
            this.setTexture('menuUI', 'Credits_Clicked.png'); this.scene.tweens.add({ targets: this, scale: 0.77, duration: 80 });
        });
        this.creditsButton.on('pointerout', function (event) {
            this.setTexture('menuUI', 'Credits_NonClicked.png'); this.scene.tweens.add({ targets: this, scale: 0.7, duration: 80 });
        });
    }
